const { icons } = require('../../../../../src/javascript/api/constructors/icons')

describe('Test Icons Component', () => {
  test('icons should be an object', () => {
    expect(typeof icons).toBe('object')
  })

  test('icons object should have valid icons', () => {
    var testIcons =  {
      default_zoom: `
	...
	<path d="M19 21L23 21V34C23 34.5523 22.5523 35 22 35H20C19.4477 35 19 34.5523 19 34V21Z" fill="var(--widgetColor)"/>
	<path d="M19 21H32C32.5523 21 33 20.5523 33 20V19H20C19.4477 19 19 19.4477 19 20V21Z" fill="var(--widgetColor)"/>
	<path d="M31 19H33V15H31V19Z" fill="var(--widgetColor)"/>
	<path d="M27 15H33V14C33 13.4477 32.5523 13 32 13H27V15Z" fill="var(--widgetColor)"/>
	<rect width="14" height="6" rx="1" transform="matrix(1 0 0 -1 13 17)" fill="var(--widgetColor)"/>
	</svg>
    ...
    expect(icons).toStrictEqual(testIcons)
  })
})